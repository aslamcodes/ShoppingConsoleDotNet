...
public class ProductUpdationTests
{
    ...
    {
        var product = productService.UpdateProduct(1, new Product(1, 110, "Phone 2A", 1));
    ...
    public void DeleteProductFails()
    {
        ...
        var exception = Assert.Throws<EntityNotFoundException>(() => productService.UpdateProduct(11, new Product(11, 110, "Phone 2A", 1)));
